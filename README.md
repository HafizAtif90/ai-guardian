...
├── docs/              # Organized guides, runbooks, and briefing material
├── run-dev.sh         # Local dev helper script
├── render.yaml        # Deployment descriptor
└── README.md

🗂 Documentation Index

All operational guides now live under `docs/`. Start with `docs/README.md` for an index that links to getting started, deployment guides, troubleshooting, and briefing collateral.
